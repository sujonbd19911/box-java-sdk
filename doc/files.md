...
* [Upload a large file in Chunks (without using helper method)](#upload-a-new-large-file-in-chunks-without-helper-method)
* [Upload a large file Version or existing file (without using helper method)](#upload-a-large-file-version-of-existing-file-in-chunks-without-helper-method)
